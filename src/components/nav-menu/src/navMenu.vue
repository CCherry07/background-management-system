<template>
  <div class="nav-menu">
    <div class="logo">
      ...
      <span v-show="!collapse" style="color: #fff; font-weight: 600"
...
export default defineComponent({
  ...
  setup() {
    let userMenu = useState("userMenu", "login");
    const router = useRouter();
    const route = useRoute();
    let defaultPage;
    const routePath = route.path;
    const findMenuRouteId = mapRoute(userMenu.value, routePath)?.id;
    defaultPage = findMenuRouteId ?? "39";
